class FestivalsRunner{
	...
	Festivals festival2=new Festivals(2,"Christmas","USA","Christianity","25/12",true);
	...
	Festivals festival3=new Festivals(3,"Ramadan","Saudi Arabia","Islam","10/04",true);
	...
	Festivals festival4=new Festivals(4,"Vesak","Sri Lanka","Buddhism","15/05",true);
	...
	Festivals festival5=new Festivals(5,"Hanukkah","Israel","Judaism","18/12",false);
	...
	Festivals festival6=new Festivals(6,"Songkran","Thailand","Buddhism","13/04",true);
	...
	Festivals festival7=new Festivals(7,"Nowruz","Iran","Zoroastrianism","21/03",true);
	...
	Festivals festival8=new Festivals(8,"Thanksgiving","Canada","Secular","14/10",true);
	...
	Festivals festival9=new Festivals(9,"Carnival","Brazil","Christianity","21/02",true);
	...
	Festivals festival10=new Festivals(10,"Holi","India","Hindu","08/03",true);
	...
	Festivals festival11=new Festivals(11,"Eid al-Adha","Indonesia","Islam","17/06",true);
	...
	Festivals festival12=new Festivals(12,"Obon","Japan","Buddhism","15/08",false);
	...
	Festivals festival13=new Festivals(13,"Halloween","USA","Secular","31/10",false);
	...
	Festivals festival14=new Festivals(14,"Gudi Padwa","India","Hindu","22/03",true);
	...
	Festivals festival15=new Festivals(15,"Mid-Autumn Festival","China","Taoism","29/09",true);
	...
	Festivals festival16=new Festivals(16,"Easter","Italy","Christianity","09/04",true);
	...
	Festivals festival17=new Festivals(17,"Navruz","Uzbekistan","Islam","21/03",true);
	...
	Festivals festival18=new Festivals(18,"Tet","Vietnam","Buddhism","10/02",true);
	...
	Festivals festival19=new Festivals(19,"Rosh Hashanah","Israel","Judaism","16/09",true);
	...
	Festivals festival20=new Festivals(20,"Guru Nanak Jayanti","India","Sikhism","27/11",true);
